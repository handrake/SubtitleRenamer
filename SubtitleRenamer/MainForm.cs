...
namespace SubtitleRenamer
{
    public partial class MainForm : Form
    {
        ...
        {
            checkedListBox1.SetItemChecked(0, Properties.Settings.Default.playAfterConversion);
            checkedListBox1.SetItemChecked(1, Properties.Settings.Default.autoSort);
        }

        private void Form1_FormClosed(object sender, FormClosedEventArgs e)
        {
            Properties.Settings.Default.playAfterConversion = checkedListBox1.GetItemChecked(0);
            Properties.Settings.Default.autoSort = checkedListBox1.GetItemChecked(1);
